...
public class RestApi {
    ...
    @GetMapping("/bateauSecurite")
    @CrossOrigin(origins = "http://localhost:3000")
    public String afficherBateauSecurite() {
        String NS = "";
        if (model != null) {
            ...
            OutputStream res =  JenaEngine.executeQueryFile(inferedModel, "data/query_Bateau_Securite.txt");
    ...
    @GetMapping("/passagerSecurite")
    @CrossOrigin(origins = "http://localhost:3000")
    public String afficherPassagerSecurite() {
        String NS = "";
        if (model != null) {
            ...
            OutputStream res =  JenaEngine.executeQueryFile(inferedModel, "data/PassagerSecurite.txt");
